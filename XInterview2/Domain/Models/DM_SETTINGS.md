...
**Использование:** Используется в [`VoiceDetector`](../Data/Audio/VoiceDetector.swift:64) для определения начала речи.
...
**Использование:** Используется в [`VoiceDetector`](../Data/Audio/VoiceDetector.swift:67) для подтверждения окончания речи.
...
**Использование:** Используется в [`VoiceDetector.handleSpeechEnd()`](../Data/Audio/VoiceDetector.swift:571) для валидации речи после ее окончания:
...
- [`loadSettings()`](../../Data/Repositories/SettingsRepository.swift:22) - Загружает настройки из UserDefaults
- [`saveSettings(_:)`](../../Data/Repositories/SettingsRepository.swift:41) - Сохраняет настройки в UserDefaults
...
|-----------|------|----------------|-----------|
| [`apiKey`](../../Presentation/ViewModels/SettingsViewModel.swift:15) | `String` | `""` | OpenAI API ключ |
| [`selectedLanguage`](../../Presentation/ViewModels/SettingsViewModel.swift:16) | `Language` | `.english` | Выбранный язык |
| [`selectedVoice`](../../Presentation/ViewModels/SettingsViewModel.swift:17) | `String` | `APIConstants.Voice.alloy` | Выбранный голос |
| [`voiceThreshold`](../../Presentation/ViewModels/SettingsViewModel.swift:18) | `Float` | `0.2` | Порог голоса |
| [`silenceTimeout`](../../Presentation/ViewModels/SettingsViewModel.swift:19) | `Double` | `1.5` | Тайм-аут тишины |
| [`minSpeechLevel`](../../Presentation/ViewModels/SettingsViewModel.swift:20) | `Float` | `0.04` | Минимальный уровень речи |
| [`calibratedNoiseLevel`](../../Presentation/ViewModels/SettingsViewModel.swift:21) | `Float?` | `nil` | Откалиброванный уровень шума |
| [`isCalibrating`](../../Presentation/ViewModels/SettingsViewModel.swift:22) | `Bool` | `false` | Флаг калибровки |
| [`calibrationProgress`](../../Presentation/ViewModels/SettingsViewModel.swift:23) | `Double` | `0.0` | Прогресс калибровки |

**Методы:**

- [`loadSettings()`](../../Presentation/ViewModels/SettingsViewModel.swift:44) - Загружает настройки из репозитория
- [`saveSettings()`](../../Presentation/ViewModels/SettingsViewModel.swift:54) - Сохраняет настройки в репозиторий
- [`calibrateNoiseLevel()`](../../Presentation/ViewModels/SettingsViewModel.swift:66) - Запускает калибровку уровня шума
...
**Компонент:** [`AudioCalibrationManager`](../../Data/Audio/AudioCalibrationManager.swift)

**Метод:** [`SettingsViewModel.calibrateNoiseLevel()`](../../Presentation/ViewModels/SettingsViewModel.swift:66)
...
- [`SettingsRepository.swift`](../../Data/Repositories/SettingsRepository.swift:10) - Репозиторий настроек
- [`SettingsViewModel.swift`](../../Presentation/ViewModels/SettingsViewModel.swift:12) - ViewModel настроек
- [`SettingsView.swift`](../../Presentation/Views/SettingsView.swift:11) - UI настроек
- [`APIConstants.swift`](../../Core/Constants/APIConstants.swift:10) - Константы API и ключи UserDefaults
