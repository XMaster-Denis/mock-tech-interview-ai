...
|-----------|------|----------------|-----------|
| [`isListening`](../../Shared/Data/Audio/VoiceDetector.swift:40) | `Bool` | `false` | Флаг прослушивания микрофона |
| [`audioLevel`](../../Shared/Data/Audio/VoiceDetector.swift:43) | `Float` | `0.0` | Текущий уровень аудио (0.0 - 1.0) |
| [`speechDetected`](../../Shared/Data/Audio/VoiceDetector.swift:46) | `Bool` | `false` | Флаг обнаружения речи |
| [`isSilenceTimerActive`](../../Shared/Data/Audio/VoiceDetector.swift:49) | `Bool` | `false` | Флаг активности таймера тишины |
| [`silenceTimerProgress`](../../Shared/Data/Audio/VoiceDetector.swift:52) | `Double` | `0.0` | Прогресс таймера тишины (0.0 - 1.0) |
| [`silenceTimerElapsed`](../../Shared/Data/Audio/VoiceDetector.swift:55) | `Double` | `0.0` | Прошедшее время в тишине (секунды) |
...
|----------|------|-----------|
| [`onVoiceEvent`](../../Shared/Data/Audio/VoiceDetector.swift:124) | `((VoiceEvent) -> Void)?` | Вызывается при событиях голосовой активности |

## События голосовой активности (VoiceEvent)

**Расположение:** [`MockTechInterviewAI/Shared/Data/Audio/VoiceDetector.swift`](../../Shared/Data/Audio/VoiceDetector.swift:21)
...
**Метод:** [`checkAudioLevel()`](../../Shared/Data/Audio/VoiceDetector.swift:318)

**Частота:** Каждые 0.05 секунды (20 раз в секунду)

**Процесс:**

1. Получение среднего уровня мощности аудио из [`AVAudioRecorder`](../../Shared/Data/Audio/VoiceDetector.swift:82)
2. Нормализация в диапазон 0.0 - 1.0 (от -60dB до 0dB)
3. Обновление [`audioLevel`](../../Shared/Data/Audio/VoiceDetector.swift:43) свойства
...
5. Отправка события [`speechStarted`](../../Shared/Data/Audio/VoiceDetector.swift:22)
...
**Метод:** [`handleSpeechEnd()`](../../Shared/Data/Audio/VoiceDetector.swift:521)
...
7. Отправка события [`speechEnded`](../../Shared/Data/Audio/VoiceDetector.swift:23) с аудиоданными
...
**Параметр:** [`minSpeechDuration`](../../Shared/Data/Audio/VoiceDetector.swift:70)
...
**Параметр:** [`minSpeechLevel`](../../Shared/Data/Audio/VoiceDetector.swift:73)
...
**Метод:** [`calculateAverageLevel(from:)`](../../Shared/Data/Audio/VoiceDetector.swift:496)
...
**Метод:** [`trimWAVData(_:startOffset:duration:)`](../../Shared/Data/Audio/VoiceDetector.swift:434)
...
**Метод:** [`startListening()`](../../Shared/Data/Audio/VoiceDetector.swift:179)
...
**Метод:** [`stopListening()`](../../Shared/Data/Audio/VoiceDetector.swift:192)
...
**Метод:** [`pauseListening()`](../../Shared/Data/Audio/VoiceDetector.swift:207)
...
**Метод:** [`resumeListening()`](../../Shared/Data/Audio/VoiceDetector.swift:214)
...
**Метод:** [`updateThreshold(_:)`](../../Shared/Data/Audio/VoiceDetector.swift:170)
...
**Метод:** [`updateSilenceTimeout(_:)`](../../Shared/Data/Audio/VoiceDetector.swift:175)
...
**Метод:** [`updateMinSpeechLevel(_:)`](../../Shared/Data/Audio/VoiceDetector.swift:180)
...
**Отправитель:** [`VoiceDetector`](../../Shared/Data/Audio/VoiceDetector.swift:35)
