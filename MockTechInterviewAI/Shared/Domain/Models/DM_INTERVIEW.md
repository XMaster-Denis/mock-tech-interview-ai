...
**Расположение:** [`MockTechInterviewAI/Shared/Domain/Models/InterviewSession.swift`](InterviewSession.swift:10)
...
**Расположение:** [`MockTechInterviewAI/Shared/Domain/Models/InterviewTopic.swift`](InterviewTopic.swift:10)
...
**Расположение:** [`MockTechInterviewAI/Shared/Domain/Models/InterviewContext.swift`](InterviewContext.swift:10)
...
**Расположение:** [`MockTechInterviewAI/Shared/Domain/Models/InterviewMode.swift`](InterviewMode.swift:10)
...
**Расположение:** [`MockTechInterviewAI/Shared/Domain/Models/TranscriptMessage.swift`](TranscriptMessage.swift:10)
...
**Расположение:** [`MockTechInterviewAI/Shared/ViewModels/InterviewViewModel.swift`](../../Shared/ViewModels/InterviewViewModel.swift:12)
...
| Свойство | Тип | По умолчанию | Описание |
|-----------|------|----------------|-----------|
| [`session`](../../Shared/ViewModels/InterviewViewModel.swift:15) | `InterviewSession` | `InterviewSession.empty` | Текущая сессия интервью |
| [`conversationState`](../../Shared/ViewModels/InterviewViewModel.swift:16) | `ConversationState` | `.idle` | Состояние разговора |
| [`audioLevel`](../../Shared/ViewModels/InterviewViewModel.swift:17) | `Float` | `0.0` | Текущий уровень аудио |
| [`voiceThreshold`](../../Shared/ViewModels/InterviewViewModel.swift:18) | `Float` | `0.15` | Порог чувствительности микрофона |
| [`errorMessage`](../../Shared/ViewModels/InterviewViewModel.swift:19) | `String?` | `nil` | Сообщение об ошибке |
| [`code`](../../Shared/ViewModels/InterviewViewModel.swift:20) | `String` | `""` | Код в редакторе |
| [`codeEditorViewModel`](../../Shared/ViewModels/InterviewViewModel.swift:21) | `CodeEditorViewModel` | - | ViewModel редактора кода |
| [`topics`](../../Shared/ViewModels/InterviewViewModel.swift:22) | `[InterviewTopic]` | `[]` | Список тем |
| [`isEditingTopic`](../../Shared/ViewModels/InterviewViewModel.swift:23) | `Bool` | `false` | Флаг редактирования темы |
| [`topicToEdit`](../../Shared/ViewModels/InterviewViewModel.swift:24) | `InterviewTopic?` | `nil` | Редактируемая тема |

**Основные методы:**

- [`loadTopics()`](../../Shared/ViewModels/InterviewViewModel.swift:111) - Загружает темы из репозитория
- [`addTopic(_:)`](../../Shared/ViewModels/InterviewViewModel.swift:125) - Добавляет новую тему
- [`updateTopic(_:)`](../../Shared/ViewModels/InterviewViewModel.swift:135) - Обновляет тему
- [`deleteTopic(id:)`](../../Shared/ViewModels/InterviewViewModel.swift:149) - Удаляет тему
- [`startEditingTopic(_:)`](../../Shared/ViewModels/InterviewViewModel.swift:163) - Начинает редактирование темы
- [`cancelEditing()`](../../Shared/ViewModels/InterviewViewModel.swift:168) - Отменяет редактирование
- [`startInterview()`](../../Shared/ViewModels/InterviewViewModel.swift:173) - Начинает интервью
- [`stopInterview()`](../../Shared/ViewModels/InterviewViewModel.swift:196) - Останавливает интервью
- [`toggleRecording()`](../../Shared/ViewModels/InterviewViewModel.swift:204) - Переключает запись
- [`selectTopic(_:)`](../../Shared/ViewModels/InterviewViewModel.swift:213) - Выбирает тему

**Вычисляемые свойства:**

| Свойство | Тип | Описание |
|-----------|------|-----------|
| [`isRecording`](../../Shared/ViewModels/InterviewViewModel.swift:244) | `Bool` | Флаг записи |
| [`canRecord`](../../Shared/ViewModels/InterviewViewModel.swift:248) | `Bool` | Можно ли записывать |
| [`recordingButtonText`](../../Shared/ViewModels/InterviewViewModel.swift:252) | `String` | Текст кнопки записи |
| [`statusText`](../../Shared/ViewModels/InterviewViewModel.swift:256) | `String` | Текст статуса |

## TopicsRepository

**Расположение:** [`MockTechInterviewAI/Shared/Data/Repositories/TopicsRepository.swift`](../../Shared/Data/Repositories/TopicsRepository.swift)
...
**Метод:** [`InterviewViewModel.addTopic(_:)`](../../Shared/ViewModels/InterviewViewModel.swift:125)
...
**Метод:** [`InterviewViewModel.updateTopic(_:)`](../../Shared/ViewModels/InterviewViewModel.swift:135)
...
**Метод:** [`InterviewViewModel.deleteTopic(id:)`](../../Shared/ViewModels/InterviewViewModel.swift:149)
...
- [`InterviewViewModel.swift`](../../Shared/ViewModels/InterviewViewModel.swift:12) - ViewModel интервью
- [`TopicsRepository.swift`](../../Shared/Data/Repositories/TopicsRepository.swift) - Репозиторий тем
